...
hcd_sheets_raw = pd.read_excel('C:/Users/MKOLEVA/Documents/Masha/Projects/HCD/Experiments/FTIR_data/Multicomponent results/Carbon_monoxide_unattended_CO.xlsx', index_col = None, sheet_name = 'Raw_data')
...
if(len(concentration[col-2]) < len(input_concentration)):
...
plt.title('FTIR Calibration curve for CO')
...
# save figure
plt.savefig('C:/Users/MKOLEVA/Documents/Masha/Projects/HCD/Experiments/FTIR_data/Multicomponent results/Test_curve_CO.png')
