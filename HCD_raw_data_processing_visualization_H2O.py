...
hcd_sheets_raw = pd.read_excel('C:/Users/MKOLEVA/Documents/Masha/Projects/HCD/Experiments/FTIR_data/Multicomponent results/Water_vapour_unattended.xlsx', index_col = None, sheet_name = 'Raw_data')
...
if(len(concentration[col-25]) < len(input_concentration)):
...
# ymax to be generic
plt.ylim(ymax = 50, ymin = -10)
plt.title('FTIR Calibration curve for H2O')
...
# save figure
plt.savefig('C:/Users/MKOLEVA/Documents/Masha/Projects/HCD/Experiments/FTIR_data/Multicomponent results/Test_curve_H2O.png')
