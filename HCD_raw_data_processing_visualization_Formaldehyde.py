...
hcd_sheets_raw = pd.read_excel('C:/Users/MKOLEVA/Documents/Masha/Projects/HCD/Experiments/FTIR_data/20-06_Formaldehyde/20_06_Formaldehyde2.xlsx', index_col = None, sheet_name = 'Raw_data')
...
while True:
    try:
        ...
        break
if target_contaminant == "HCHO(PPM)":
...
if target_contaminant in hcd.columns:
    if(target_contaminant == 'HCHO(PPM)'):
        input_concentration = [0, 5.7, 3, 2, 1, 0.5, 0.3]
else:
...
if(len(concentration[col-20]) < len(input_concentration)):
...
# plotting
area = np.pi*3
figFormcalib = plt.scatter(input_concentration, avg_response_concentration, s = area, alpha = 0.5, c = 'k')
# ymax to be generic
plt.ylim(ymax = 7, ymin = 0)
plt.title('FTIR Calibration curve for Formaldehyde/N')
...
# save figure
figFormcalib.savefig('C:/Users/MKOLEVA/Documents/Masha/Projects/HCD/Experiments/FTIR_data/Multicomponent results/Test_curve_Formaldehyde.png')
